  ...
  return (
    <section className="bg-white px-6 py-28">
      <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        <h2 className="text-3xl font-light text-dark-blue sm:text-4xl md:text-5xl">
        ...
        <a
          ...
          className="mt-12 rounded-full bg-accent-teal px-10 py-4 text-base font-semibold text-dark-blue transition-colors duration-200 hover:bg-[#00A8C4]"
        >
          Get in Touch
        </a>
